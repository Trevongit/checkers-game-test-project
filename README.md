...
**Play:** https://trevongit.github.io/checkers-game-test-project/

Open that URL, or open `index.html` in a browser. Red moves first. Jumps are mandatory. GitHub Pages serves `main`.
